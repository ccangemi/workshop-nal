...
# sostituire
# database-connection-string: 'mssql+pymssql://defaultMssqladmin@saiworkshopsql01azwe:4_Mp%25p8H0o9%25Nzy3@saiworkshopsql01azwe.database.windows.net:1433/db01'
```
